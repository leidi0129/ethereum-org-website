...
- `maxPriorityFeePerGas` - the maximum fee per gas to be included as a tip to the miner
- `maxFeePerGas` - the maximum fee per gas willing to be paid for the transaction (inclusive of `baseFeePerGas` and `maxPriorityFeePerGas`)
